...
public class BloomFilter {
    private int defaultSize = 2147483640;// <<是移位运算
    /**
     ...
     * @return
     */
    public boolean exist(Element ele){
        int keyCode[] = indexInSet(ele);
    ...
    public static void main(String[] args) {
    	...
    	Element ele = new Element("http://lfeldhaus.tripod.com/cmdrjackfeldhaususn/id14.html ");
